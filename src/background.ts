...
async function gitpodifyCurrentTab(tab) {
  try {
    ...
    browser.scripting.executeScript({
      ...
      func: () => {
        const extensionIconClickedElement = document.createElement("div");
        extensionIconClickedElement.id = "gitpod-extension-icon-clicked";
        extensionIconClickedElement.style.display = "none";
        document.body.appendChild(extensionIconClickedElement);
      },
    });
    browser.scripting.executeScript({
