...
4. Navigate to the [Chrome Webstore console](https://chrome.google.com/webstore/devconsole/11ad35cc-5b54-416a-a789-f091e1007648), make sure you switch the `publisher` to `Gitpod`
5. Click "Upload new package"
6. Upload the zip file (`chrome-mv3-prod.zip`) and submit
